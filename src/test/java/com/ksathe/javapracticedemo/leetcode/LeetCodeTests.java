...
public class LeetCodeTests {
    ...
    @Test
    public void testLeetCode09() {
        Solution1776 s = new Solution1776();
        int[][] cars1 = {{1,2},{2,1},{4,3},{7,2}};
        double[] ans1 = {1.00000,-1.00000,3.00000,-1.00000};
        assertTrue(doubleArraysEqual(ans1, s.getCollisionTimes(cars1)));
        //2
